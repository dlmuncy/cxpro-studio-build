          ...
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              <h2 className="font-bold text-sm text-[#1A1A1A] dark:text-white uppercase tracking-wider flex items-center gap-2">
                <span>CXPro Legal & Compliance Center</span>
            ...
            <div className="space-y-5">
              <div className="p-3.5 bg-orange-50 dark:bg-orange-950/20 border border-orange-200 dark:border-orange-900/50 rounded flex items-start space-x-3">
                ...
                <p className="text-[11px] text-orange-900 dark:text-orange-200">
                  <strong>Summary:</strong> By accessing <strong>CXPro</strong> (cxpro.site), you agree to these Terms. CXPro is an AI-powered legal contract risk auditing and redline analysis platform designed to assist in-house counsel, contractors, legal engineers, and enterprises.
                </p>
              </div>
              ...
              <section className="space-y-2">
                ...
                <p>
                  By creating an account, selecting a subscription tier, or uploading documents to CXPro, you agree to be bound by these Terms of Service. You may use our service solely for lawful contract review, drafting, counter-proposal creation, and risk assessment purposes.
                </p>
              </section>
              ...
              <section className="space-y-2">
                ...
                <p>
                  CXPro offers recurring subscription plans (Student/QA $49.99/mo, Starter $149/mo, Professional $349/mo, and Enterprise $699/mo). Payments are processed securely via <strong>Stripe</strong>. Your subscription automatically renews each billing period unless canceled prior to the renewal date.
                </p>
              ...
              <section className="space-y-2">
                ...
                <p>
                  <strong>You retain 100% full ownership</strong> of all contracts, clauses, prompt templates, redline exports, DOCX files, and proprietary data uploaded to or generated by CXPro. CXPro claims no ownership rights over your input contracts or redlined output work product.
                </p>
              </section>
              ...
              <section className="space-y-2">
                ...
                <p>
                  To the maximum extent permitted by law, CXPro and its operators shall not be liable for any indirect, incidental, punitive, or consequential damages resulting from contract negotiations, commercial disputes, or legal outcomes arising from the use of our software. Total liability is limited to the fees paid by you in the 12 months preceding the claim.
                </p>
              </section>
              ...
              <section className="space-y-2">
                ...
                <p>
                  ...
                  <br />
                  <strong>CXPro Legal & Support:</strong> <a href="mailto:support@cxpro.site" className="text-[#F97316] font-bold hover:underline font-mono">support@cxpro.site</a>
                </p>
              </section>
            </div>
          )}
            ...
            <div className="space-y-5">
              <div className="p-3.5 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900/50 rounded flex items-start space-x-3">
                ...
                <p className="text-[11px] text-blue-900 dark:text-blue-200">
                  <strong>Zero-Training Guarantee:</strong> Your contract data is strictly private. CXPro <strong>NEVER</strong> uses your uploaded contracts, redlines, or confidential playbooks to train, retrain, or fine-tune public foundation AI models.
                </p>
              </div>
              ...
              <section className="space-y-2">
                ...
                <ul className="list-disc pl-5 space-y-1 text-[11px] text-slate-600 dark:text-slate-300">
                  ...
                  <li><strong>Billing Data:</strong> Payment details (credit card number, billing address) are processed directly by <strong>Stripe</strong> via tokenized PCI-DSS Level 1 compliant infrastructure. CXPro never stores raw card numbers.</li>
                </ul>
              </section>
              ...
              <section className="space-y-2">
                ...
                <p>
                  You have full control over your contract audit history. You may purge scanned contracts and audit trails at any time directly from the CXPro dashboard or request a permanent data purge by emailing <span className="font-mono text-[#F97316]">support@cxpro.site</span>.
                </p>
              </section>
            ...
            <div className="space-y-5">
              <div className="p-3.5 bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-200 dark:border-emerald-900/50 rounded flex items-start space-x-3">
                ...
                <p className="text-[11px] text-emerald-900 dark:text-emerald-200">
                  <strong>Legal Technology Disclaimer:</strong> CXPro is an autonomous AI-driven contract intelligence and legal engineering platform. CXPro does not provide formal legal advice and does not create an attorney-client relationship.
                </p>
              </div>
